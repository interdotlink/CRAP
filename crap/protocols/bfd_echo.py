...
class BfdEcho(BaseHeader):
    def __init__(self: BfdEcho) -> None:
        self.data = (
            IP(
            ...
            / UDP(
                dport=Settings.BFD_ECHO_DST_PORT,
                sport=Settings.BFD_ECHO_SRC_PORT,
            )
        ...
        self.set_filter(
            ...
            f" and udp"
            f" and dst port {Settings.BFD_ECHO_DST_PORT}"
            f" and src port {Settings.BFD_ECHO_SRC_PORT}"
        )

...
class MldV2Report(BaseHeader):
    def __init__(self: MldV2Report) -> None:
        """
        ...
        self.set_filter(
            ...
            f" and dst {Settings.IPV6_MC_MLDV2}"
            f" and ip6[{len(IPv6()/IPv6ExtHdrHopByHop())}] =="
            f" {Settings.ICMPV6_TYPE_MLD_REPORTV2}"
        )

        build_l2(
            dst=Settings.MAC_MC_IPV6_MLDV2,
            eth2=True,
            etype=ETH_P_IPV6,
            header=self,
